...
public class AddFeedImgAdapter2 extends RecyclerView.Adapter<AddFeedImgAdapter2.MyViewHolder> {
   private Context context;
   private ArrayList<Uri> arrayListFeedImg = new ArrayList<>();



   public AddFeedImgAdapter2(Context context, ArrayList arrayList){
    ...
    @NonNull
    @Override
    public AddFeedImgAdapter2.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

       //리사이클러뷰에 들어갈 아이템xml파일 inflate
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_add_feed_img2, parent,false);

        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddFeedImgAdapter2.MyViewHolder holder, int position) {
